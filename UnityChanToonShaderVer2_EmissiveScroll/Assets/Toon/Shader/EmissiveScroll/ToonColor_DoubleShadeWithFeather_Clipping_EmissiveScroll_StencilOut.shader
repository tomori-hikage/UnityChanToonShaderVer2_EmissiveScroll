Shader "UnityChanToonShader/EmissiveScroll/NoOutline/ToonColor_DoubleShadeWithFeather_Clipping_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_Clipping_StencilOut/FORWARD"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_Clipping_StencilOut/FORWARD_DELTA"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_Clipping_StencilOut/SHADOWCASTER"
    }
