Shader "UnityChanToonShader/EmissiveScroll/NoOutline/ToonColor_DoubleShadeWithFeather_Clipping_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_Clipping_StencilMask/FORWARD"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_Clipping_StencilMask/FORWARD_DELTA"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_Clipping_StencilMask/SHADOWCASTER"
    }
