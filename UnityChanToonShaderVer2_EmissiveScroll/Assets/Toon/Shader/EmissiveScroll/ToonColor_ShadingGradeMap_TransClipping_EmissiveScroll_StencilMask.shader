Shader "UnityChanToonShader/EmissiveScroll/NoOutline/ToonColor_ShadingGradeMap_TransClipping_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_ShadingGradeMap_TransClipping_StencilMask/FORWARD"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_ShadingGradeMap_TransClipping_StencilMask/FORWARD_DELTA"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_ShadingGradeMap_TransClipping_StencilMask/SHADOWCASTER"
    }
