Shader "UnityChanToonShader/EmissiveScroll/Mobile/Toon_DoubleShadeWithFeather_StencilOut" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_StencilOut/OUTLINE"
