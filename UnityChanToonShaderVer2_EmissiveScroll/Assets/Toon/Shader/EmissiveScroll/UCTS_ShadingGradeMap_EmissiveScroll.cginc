...
//v.2.0.4
                ...
                finalColor =  saturate(finalColor) + (envLightColor*envLightIntensity*_GI_Intensity*smoothstep(1,0,envLightIntensity/2)) + (_Emissive_Tex_var.rgb*_Emissive_Color.rgb*emissiveBlink);//Final Composition
