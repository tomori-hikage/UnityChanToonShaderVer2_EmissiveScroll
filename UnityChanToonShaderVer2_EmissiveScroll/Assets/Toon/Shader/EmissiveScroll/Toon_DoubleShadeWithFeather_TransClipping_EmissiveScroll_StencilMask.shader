Shader "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_TransClipping_StencilMask" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        Pass {
            ...
            //アウトライン処理は以下のUCTS_Outline_EmissiveScroll.cgincへ.
            #include "UCTS_Outline_EmissiveScroll.cginc"
            ENDCG
        }
//ToonCoreStart
        Pass {
            ...
            #include "UCTS_DoubleShadeWithFeather_EmissiveScroll.cginc"
        ...
        Pass {
            ...
            //v.2.0.4
            #pragma multi_compile _IS_CLIPPING_TRANSMODE
            #include "UCTS_ShadowCaster_EmissiveScroll.cginc"
            ENDCG
        }
//ToonCoreEnd
    }
