Shader "UnityChanToonShader/EmissiveScroll/NoOutline/ToonColor_DoubleShadeWithFeather_TransClipping_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/FORWARD"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/FORWARD_DELTA"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/SHADOWCASTER"
    }
