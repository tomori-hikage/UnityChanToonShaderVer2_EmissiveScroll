Shader "UnityChanToonShader/EmissiveScroll/Mobile/Toon_DoubleShadeWithFeather" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather/OUTLINE"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_DoubleShadeWithFeather/FORWARD"
