Shader "UnityChanToonShader/EmissiveScroll/NoOutline/ToonColor_ShadingGradeMap" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_ShadingGradeMap/FORWARD"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_ShadingGradeMap/FORWARD_DELTA"
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_ShadingGradeMap/SHADOWCASTER"
