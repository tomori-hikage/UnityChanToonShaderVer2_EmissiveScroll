...
//UTS2EmissiveScrollGUI.cs for UTS2 v.2.0.6
...
namespace UnityChan
{
    public class UTS2EmissiveScrollGUI : ShaderGUI {
    ...
    //EmissiveBlink
        MaterialProperty emissiveBlink_Min = null;
        MaterialProperty emissiveBlink_Max = null;
        MaterialProperty emissiveBlink_Velocity = null;
    //EmissiveScroll
        MaterialProperty emissiveScroll_Direction = null;
        MaterialProperty emissiveScroll_Width = null;
        MaterialProperty emissiveScroll_Velocity = null;
        MaterialProperty emissiveScroll_Interval = null;
    ...
    //EmissiveBlink
            emissiveBlink_Min = FindProperty("_EmissiveBlink_Min", props);
            emissiveBlink_Max = FindProperty("_EmissiveBlink_Max", props);
            emissiveBlink_Velocity = FindProperty("_EmissiveBlink_Velocity", props);
    //EmissiveScroll
            emissiveScroll_Direction = FindProperty("_EmissiveScroll_Direction", props);
            emissiveScroll_Width = FindProperty("_EmissiveScroll_Width", props);
            emissiveScroll_Velocity = FindProperty("_EmissiveScroll_Velocity", props);
            emissiveScroll_Interval = FindProperty("_EmissiveScroll_Interval", props);
    ...
    // --------------------------------
        ...
        void GUI_Emissive(Material material)
        {
            ...
            //EmissiveBlink
            GUILayout.Label("Emissive Blink", EditorStyles.boldLabel);
            m_MaterialEditor.FloatProperty(emissiveBlink_Min, "EmissiveBlink Min");
            m_MaterialEditor.FloatProperty(emissiveBlink_Max, "EmissiveBlink Max");
            m_MaterialEditor.FloatProperty(emissiveBlink_Velocity, "EmissiveBlink Velocity");

            //EmissiveScroll
            GUILayout.Label("Emissive Scroll", EditorStyles.boldLabel);
            m_MaterialEditor.VectorProperty(emissiveScroll_Direction, "EmissiveScroll Direction");
            m_MaterialEditor.FloatProperty(emissiveScroll_Width, "EmissiveScroll Width");
            m_MaterialEditor.FloatProperty(emissiveScroll_Velocity, "EmissiveScroll Velocity");
            m_MaterialEditor.FloatProperty(emissiveScroll_Interval, "EmissiveScroll Interval");
