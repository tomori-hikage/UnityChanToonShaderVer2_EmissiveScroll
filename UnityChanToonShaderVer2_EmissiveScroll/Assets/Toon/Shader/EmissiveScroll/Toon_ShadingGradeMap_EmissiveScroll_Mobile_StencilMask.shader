Shader "UnityChanToonShader/EmissiveScroll/Mobile/Toon_ShadingGradeMap_StencilMask" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_ShadingGradeMap_StencilMask/OUTLINE"
