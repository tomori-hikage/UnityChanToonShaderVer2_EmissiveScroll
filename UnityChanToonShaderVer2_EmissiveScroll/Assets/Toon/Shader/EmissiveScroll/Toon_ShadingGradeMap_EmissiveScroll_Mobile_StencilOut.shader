Shader "UnityChanToonShader/EmissiveScroll/Mobile/Toon_ShadingGradeMap_StencilOut" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/EmissiveScroll/Toon_ShadingGradeMap_StencilOut/OUTLINE"
